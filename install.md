...
* 6.1 builds can be found here: https://www.virtualbox.org/wiki/Download_Old_Builds_6_1).
* 6.1.34 can be found here: https://download.virtualbox.org/virtualbox/6.1.34/
